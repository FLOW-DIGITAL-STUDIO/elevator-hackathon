...
import { getPlayers } from "../../app/api/getPlayers";
        ...
        <tbody>
         {players.map((player)=>{
          return(
            ...
            <td className="px-5 py-5 border-b  bg-white text-sm">
              <p className="text-gray-900 whitespace-no-wrap">{player.lastName}</p>
            </td>
            <td className="px-5 py-5 border-b  bg-white text-sm">
              <p className="text-gray-900 whitespace-no-wrap">{player.firstname}</p>
            </td>
            <td className="px-5 py-5 border-b  bg-white text-sm">
              <p className="text-gray-900 whitespace-no-wrap">{player.goal}</p>
            </td>
